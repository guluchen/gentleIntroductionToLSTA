...
\draw[bend right=30,->,>=stealth](pl) to coordinate[pos=0.2] (pllm)(q0.west);
\draw[bend right=30,->,>=stealth,dotted](pl) to coordinate[pos=0.3] (plrm)(q1.north);

\draw[bend left=30,->,>=stealth](pr) to coordinate[pos=0.2] (prrm)(q1.east);
\draw[bend left=30,->,>=stealth,dotted](pr) to coordinate[pos=0.3] (prlm)(q0.north);


\draw[fill=blue!10] (pl) to [bend left=6]  (pllm) to [bend left=50]  (plrm) to [bend left=12] cycle;

\draw[fill=red!10] (pr) to [bend right=6]  (prrm) to [bend right=50]  (prlm) to [bend right=12] cycle;
...
\draw[bend right=40,->,>=stealth,dotted](q1l) to coordinate[pos=0.4] (q1llm)(r1);
\draw[bend right=30,->,>=stealth](q1l) to coordinate[pos=0.15] (q1lrm)(r0);

\draw[fill=blue!10] (q1l) to [bend right=16]  (q1llm) to [bend right=45]  (q1lrm) to [bend right=3] cycle;

\draw[bend left=50,->,>=stealth](q1r) to coordinate[pos=0.5] (q1rlm)(r1);
\draw[bend right=1,->,>=stealth,dotted](q1r) to coordinate[pos=0.3] (q1rrm)(r0);
\draw[fill=red!10] (q1r) to [bend left=25]  (q1rlm) to [bend right=50]  (q1rrm) to [bend left=0.3] cycle;


\draw ($(q0.south)+(0pt,0pt)$) -- (q0b);
\draw[bend right=40,->,>=stealth,dotted](q0b) to coordinate[pos=0.4] (q0blm)(r0);
\draw[bend left=40,->,>=stealth](q0b) to coordinate[pos=0.4] (q0brm)(r0);
\draw[fill=red!10] (q0b) to [bend right=16]  (q0blm) to [bend right=50]  (q0brm) to [bend right=16] cycle;
...
\draw[bend right=40,->,>=stealth,dotted](r1l) to coordinate[pos=0.4] (r1llm)(s1);
\draw[bend right=30,->,>=stealth](r1l) to coordinate[pos=0.15] (r1lrm)(s0);

\draw[fill=red!10] (r1l) to [bend right=16]  (r1llm) to [bend right=45]  (r1lrm) to [bend right=3] cycle;

\draw[bend left=50,->,>=stealth](r1r) to coordinate[pos=0.5] (r1rlm)(s1);
\draw[bend right=1,->,>=stealth,dotted](r1r) to coordinate[pos=0.3] (r1rrm)(s0);
\draw[fill=blue!10] (r1r) to [bend left=25]  (r1rlm) to [bend right=50]  (r1rrm) to [bend left=0.3] cycle;


\draw ($(r0.south)+(0pt,0pt)$) -- (r0b);
\draw[bend right=40,->,>=stealth,dotted](r0b) to coordinate[pos=0.4] (r0blm)(s0);
\draw[bend left=40,->,>=stealth](r0b) to coordinate[pos=0.4] (r0brm)(s0);
\draw[fill=red!10] (r0b) to [bend right=16]  (r0blm) to [bend right=50]  (r0brm) to [bend right=16] cycle;
