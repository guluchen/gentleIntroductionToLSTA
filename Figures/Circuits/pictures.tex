...
\node[name=x1]{$\ketof{\xvar_1}$};
\node[name=x2,anchor=north] at 
($(x1.south)+(0pt,-20pt)$){$\ketof{\xvar_2}$};
...
\draw[bend left=30,->,>=stealth](q0B) to coordinate[pos=0.2] (q0Brm)(q3);
...
\draw[bend right=30,->,>=stealth](q1B) to coordinate[pos=0.2] (q1Brm)(q2);
...
\node[anchor=north east,inner sep=0pt,font=\tiny]at($(q1B.south)+(0pt,-1pt)$){$\xvar_2$};
