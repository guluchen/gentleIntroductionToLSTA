...
\ol{this page does not look nice}
...
\begin{figure}[ht] 
    ...
    \caption{(a)~A tree automaton for generating all basis states of $3$ qubits.
      ...
      (b)~The tree corresponding to $[0\;0\;0\;0\;0\;0\;1\;0]^T$. The red rules in the automaton are those used to generate the tree. \ol{I don't see red rules}
...
\ol{there is an inconsistency between $x_0, x_1$ in the automata and $x_1, x_2$ in the circuit.
  Also, there is $x_2$ in  (c) --- not sure what it denotes}
\ol{dashed/solid lines are missing}
  }
\label{Bells:fig}
\end{figure}
